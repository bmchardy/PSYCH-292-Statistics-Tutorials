...
This *t*-test is only slightly different from the above because, instead of looking at within-participant across time or across intervention, we look at two different (independent) groups of participants experience significantly different change.
...
Really, there are only two differences between the dependent and independent samples *t*. First, by design, two independent samples have the chance to be of different sizes ($n$'s).
...
t = (M_classical_change - M_control_change) /
  sqrt((SD_classical_change^2 / N_classical)
         + (SD_control_change^2 / N_classical))
...
Therefore, we believe the classical music intervention is actively improving the well-being of PSYCH 292 students.
...
(I'm going to go to bed now because stats makes me lose track of time; it's 3AM and is therefore past my bedtime.)